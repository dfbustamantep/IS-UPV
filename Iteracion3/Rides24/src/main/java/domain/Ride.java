...
public class Ride implements Serializable {
	...
	private String from;
	private String to;
	private float nPlaces;
	private Date date;
	private double price;
	
	@OneToMany(fetch=FetchType.LAZY,cascade=CascadeType.PERSIST)
	public ArrayList<String> paradasIntermedias;  //Solo se utilizara para viajes compuestos
	...
	public Ride(String from, String to,  Date date, int nPlaces, double precio, Driver driver) {
		super();
		this.from = from;
		this.to = to;
		this.nPlaces = nPlaces;
	...
	public Ride(String from, String to,  Date date, int nPlaces, float price, Driver driver, ArrayList<String> paradasIntermedias) {
		super();
		this.from = from;
		this.to = to;
		this.nPlaces = nPlaces;
	...
	public void setBetMinimum(float nPlaces) {
		this.nPlaces = nPlaces;
	}
